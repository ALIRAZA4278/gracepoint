        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 sm:gap-8">
            ...
            <div className="lg:col-span-1">
              <nav className="space-y-2">
                <button
                  ...
                  className={`block w-full text-left px-3 sm:px-4 py-2.5 sm:py-3 font-urbanist font-semibold text-xs sm:text-sm rounded transition-colors ${
            ...
            <div className="lg:col-span-3">
              <p className="text-gray-900 font-urbanist text-xs sm:text-sm mb-6 sm:mb-8">
          ...
          <div id="info-collect" className="mb-6 sm:mb-8">
            ...
            <p className="text-gray-900 font-urbanist text-xs sm:text-sm leading-relaxed mb-2 sm:mb-3">
          ...
          <div id="how-use" className="mb-6 sm:mb-8">
            ...
            <ul className="list-disc pl-5 sm:pl-6 space-y-1 sm:space-y-2">
              <li className="text-gray-900 font-urbanist text-xs sm:text-sm leading-relaxed">
          ...
          <div id="data-sharing" className="mb-6 sm:mb-8">
            ...
            <p className="text-gray-900 font-urbanist text-xs sm:text-sm leading-relaxed mt-2 sm:mt-3">
          ...
          <div className="mb-6 sm:mb-8">
            ...
            <p className="text-gray-900 font-urbanist text-xs sm:text-sm leading-relaxed">
